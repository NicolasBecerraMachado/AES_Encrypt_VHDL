...
namespace eval ::optrace {
  variable script "D:/repos/AES_Encrypt_VHDL/AES_encryption/AES_encryption.runs/synth_1/AES_wiring_wrapper.tcl"
...
synth_design -top AES_wiring_wrapper -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef AES_wiring_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file AES_wiring_wrapper_utilization_synth.rpt -pb AES_wiring_wrapper_utilization_synth.pb"
