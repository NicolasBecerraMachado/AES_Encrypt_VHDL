...
design_libs=(xpm xlconcat_v2_1_4 xil_defaultlib xlslice_v1_0_2)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  ...
  vlogan -work xlconcat_v2_1_4 $vlogan_opts +v2k +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  "../../../bd/AES_wiring/ip/AES_wiring_xlconcat_0_0/sim/AES_wiring_xlconcat_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AES_wiring xil_defaultlib.glbl -o AES_wiring_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AES_wiring_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AES_wiring_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AES_wiring_simv.daidir vcs_lib c.obj)
