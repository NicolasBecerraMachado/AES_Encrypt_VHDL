...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlconcat_v2_1_4 -L xil_defaultlib -L xlslice_v1_0_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AES_wiring xil_defaultlib.AES_wiring xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AES_wiring -key {Behavioral:sim_1:Functional:AES_wiring} -tclbatch cmd.tcl -protoinst "protoinst_files/AES_wiring.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/AMDSOFT/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AES_wiring.wdb xsim.dir libdpi.so)
