...
#
# Script generated by Vivado on Wed Dec 20 13:51:04 +0100 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : AES_wiring.sh
...
#
# Usage        : AES_wiring.sh
#                AES_wiring.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AES_wiring.sh [-reset_run]
#                AES_wiring.sh [-reset_log]
#                AES_wiring.sh [-help]
#
...
#                script (type 'AES_wiring.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xlconcat_v2_1_4 -libname xil_defaultlib -libname xlslice_v1_0_2 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xlconcat_v2_1_4 xil_defaultlib xlslice_v1_0_2)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AES_wiring.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AES_wiring.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  ...
  xmvlog -work xlconcat_v2_1_4 $xmvlog_opts +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
  "../../../bd/AES_wiring/ip/AES_wiring_xlconcat_0_0/sim/AES_wiring_xlconcat_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xlslice_v1_0_2 $xmvlog_opts +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/1b7e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/122e/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/affe/hdl/verilog" +incdir+"../../../../AES_encryption.srcs/sources_1/bd/AES_wiring/ipshared/20d0/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AES_wiring xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AES_wiring -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AES_wiring_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AES_wiring.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AES_wiring.sh [-help]\n\
Usage: AES_wiring.sh [-step]\n\
Usage: AES_wiring.sh [-lib_map_path]\n\
Usage: AES_wiring.sh [-reset_run]\n\
Usage: AES_wiring.sh [-reset_log]\n\
Usage: AES_wiring.sh [-keep_index]\n\
Usage: AES_wiring.sh [-noclean_files]\n\n\
